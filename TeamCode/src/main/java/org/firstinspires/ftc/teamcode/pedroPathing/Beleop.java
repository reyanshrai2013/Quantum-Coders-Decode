...
@TeleOp(name = "MAIN BELEOP CODE", group = "StarterBot")
    ...
    public void loop() {
        ...
        switch (launchState) {
            ...
            case SPIN_UP:
                ...
                if (Math.abs(launcher.getVelocity() - launcherTargetVelocity)
                        < VELOCITY_TOLERANCE) {
...
// dhruvi is a big mac
        ...
        telemetry.addData("Launcher Actual RPM", launcher.getVelocity());
        telemetry.addData(
                "Launcher At Speed",
                Math.abs(launcher.getVelocity() - launcherTargetVelocity)
                        < VELOCITY_TOLERANCE
        );
        telemetry.update();
    }
